  ...
  return (
    <div id="aboutUs" className="w-full">
      <div className="flex flex-col md:flex-row w-full lg:h-[400px]">
        ...
        <div className="w-full md:w-1/2 px-4 md:px-6 lg:px-8 py-6 md:py-4 lg:py-6 flex flex-col justify-center bg-zinc-50 text-zinc-700 dark:bg-zinc-700 dark:text-zinc-50 ">
          <h1 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 lg:mb-6">
